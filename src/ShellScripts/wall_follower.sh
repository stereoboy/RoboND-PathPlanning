...
sleep 5
xterm  -e  " source $ABS_DEVEL_PATH/setup.bash & roslaunch wall_follower gmapping.launch" & 
sleep 2
...
#sleep 2
xterm  -e  " source $ABS_DEVEL_PATH/setup.bash & roslaunch wall_follower wall_follower.launch"
